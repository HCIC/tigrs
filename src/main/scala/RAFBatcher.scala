...
// from: https://github.com/ochrons/diode/blob/master/examples/raf/src/main/scala/example/RAFBatcher.scala
...
private[tigrs] final case class RAFWrapper(action: AnyRef, dispatch: Dispatcher)
